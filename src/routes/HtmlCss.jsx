...
const HtmlCss = () => {
  ...
  const [iframeSrc, setIframeSrc] = useState(
    "https://www.youtube.com/embed/lSZ9jKHs4oA?rel=0",
  );
  ...
  const togglePlay = () => {
    ...
    setIframeSrc(
      `https://www.youtube.com/embed/lSZ9jKHs4oA?rel=0${autoplayParam}${muteParam}`,
    );
  };
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  comprehensive HTML & CSS course. Learn how to create
                  beautiful, responsive websites from scratch. This course
                  covers everything from basic HTML structure to advanced CSS
                  techniques including Flexbox, Grid, animations, and responsive
                  design principles.
                </p>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <textarea
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-blue-500  focus:outline-none focus:border-transparent"
                        rows="3"
                      />
                      <button
                        onClick={handleAddComment}
                        className="mt-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg cursor-pointer font-medium transition-colors"
                      >
                        Post Comment
                      </button>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        Great explanation! The CSS Grid section really helped me
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        The responsive design examples are perfect. Can't wait
                        to apply these techniques to my projects!
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                          <ThumbsUp className="w-4 h-4" />
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        Finally understood Flexbox after watching this video.
                        The instructor explains complex concepts so clearly.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                          <ThumbsUp className="w-4 h-4" />
