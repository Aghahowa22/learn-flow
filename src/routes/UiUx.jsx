...
const UiUx = () => {
  ...
  const [likes, setLikes] = useState(1156);
        ...
        <div className=" ml-5 p-4 md:mt-22 md:ml-64">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center space-x-4 text-gray-600">
              ...
              <span>•</span>
              <span>9 weeks • Beginner Level</span>
              <span>•</span>
              <span>by Designed by Eratech</span>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-black rounded-xl overflow-hidden shadow-2xl mb-6">
                <div className="relative">
                  <iframe
                    ...
                    src={iframeSrc}
                    title="UI/UX Design Masterclass Video"
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Master modern UI/UX design principles and learn to create
                  stunning, user-centered digital products. Discover the
                  fundamentals of user research, wireframing, prototyping, and
                  visual design. Work with industry-standard tools and
                  real-world case studies to build a professional design
                  portfolio.
                </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-500">1,892 reviews</span>
                  </div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <button
                        ...
                        className="mt-2 bg-blue-600 hover:bg-blue-700 cursor-pointer text-white px-4 py-2 rounded-lg font-medium transition-colors"
                      >
                        Post Comment
                      </button>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        This course transformed my understanding of UX design.
                        The project-based approach really helped me build a
                        strong portfolio!
                      </p>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        The instructor's explanations of design principles are
                        crystal clear. Highly recommend for anyone wanting to
                        learn UI/UX.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                  ...
                  <div className="flex space-x-3">
                    <div className="w-8 h-8 bg-teal-500 rounded-full flex items-center justify-center">
                      <span className="text-white text-sm font-medium">NC</span>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <span className="font-medium text-gray-900">
                      ...
                      <p className="text-gray-700">
                        Great introduction to design thinking and user research.
                        The case studies really bring the concepts to life!
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                          <ThumbsUp className="w-4 h-4" />
