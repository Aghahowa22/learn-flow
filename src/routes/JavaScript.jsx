...
const JavaScript = () => {
  ...
  const [likes, setLikes] = useState(1289);
  ...
  const [iframeSrc, setIframeSrc] = useState(
    "https://www.youtube.com/embed/PkZNo7MFNFg?rel=0",
  );
  ...
  const togglePlay = () => {
    ...
    setIframeSrc(
      `https://www.youtube.com/embed/PkZNo7MFNFg?rel=0${autoplayParam}${muteParam}`,
    );
  };
  ...
  const handleComplete = () => {
    setIsCompleted(true);
    setCourseSuccess(
      "Congratulations! You've completed the JavaScript Fundamentals course!",
    );
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center space-x-4 text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>(2,150 reviews)</span>
              </div>
              <span>•</span>
              <span>6 weeks • Beginner Level</span>
              <span>•</span>
              <span>by Yuki Promise</span>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-black rounded-xl overflow-hidden shadow-2xl mb-6">
                <div className="relative">
                  <iframe
                    ...
                    src={iframeSrc}
                    title="JavaScript Fundamentals Course Video"
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Master JavaScript fundamentals and become proficient in one of
                  the most popular programming languages. Learn core concepts
                  including variables, functions, loops, events, and DOM
                  manipulation. Build real-world projects and understand modern
                  JavaScript practices with practical examples and hands-on
                  coding exercises.
                </p>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-medium">156 Comments</span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <button
                        ...
                        className="mt-2 bg-blue-600 cursor-pointer hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition-colors"
                      >
                        Post Comment
                      </button>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        This course clarified so many JavaScript concepts I was
                        confused about. Highly recommended!
                      </p>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        The practical exercises at the end of each section
                        really helped me understand the concepts better.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                          <ThumbsUp className="w-4 h-4" />
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        Perfect course for beginners. The instructor explains
                        everything in a way that's easy to understand. Worth
                        every penny!
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
