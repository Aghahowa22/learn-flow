...
const NodeJs = () => {
  ...
  const [likes, setLikes] = useState(1423);
  ...
  const [iframeSrc, setIframeSrc] = useState(
    "https://www.youtube.com/embed/TlB_eWDSMt4?rel=0",
  );
  ...
  const togglePlay = () => {
    ...
    setIframeSrc(
      `https://www.youtube.com/embed/TlB_eWDSMt4?rel=0${autoplayParam}${muteParam}`,
    );
  };
  ...
  const handleComplete = () => {
    setIsCompleted(true);
    setCourseSuccess("Congratulations! You've completed the Node.js course!");
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center space-x-4 text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>(2,650 reviews)</span>
              </div>
              <span>•</span>
              <span>7 weeks • Intermediate Level</span>
              <span>•</span>
              <span>by James Iyobosa</span>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Master server-side JavaScript development with Node.js. Build
                  scalable backend applications, RESTful APIs, and real-time
                  applications. This comprehensive course covers everything from
                  Node.js fundamentals to advanced concepts like authentication,
                    ...
                    <div className="flex-1">
                      <textarea
                       name="comment"
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:outline-none focus:ring-blue-500 focus:border-transparent"
                        rows="3"
                      />
                      <div className="flex justify-between items-center mt-2">
                        <button
                          onClick={handleAddComment}
                          className="bg-blue-600 hover:bg-blue-700 cursor-pointer text-white px-4 py-2 rounded-lg font-medium transition-colors"
                        >
                          Post Comment
                        </button>
                      </div>
                ...
                <div className="space-y-4">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        The Express.js section was incredibly helpful! I built
                        my first API following along. The middleware
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        Finally understood async/await and promises! The
                        real-world examples with database integration made
                        everything click.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        The JWT authentication and MongoDB integration sections
                        were exactly what I needed for my startup project.
                        Highly recommended!
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-500">2,650 reviews</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-medium">137 Comments</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900">James Iyobosa</h4>
