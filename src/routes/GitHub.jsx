...
const GitHub = () => {
  ...
  const togglePlay = () => {
    ...
    setIframeSrc(
      `https://www.youtube.com/embed/RGOj5yH7evk?rel=0${autoplayParam}${muteParam}`,
    );
  };
  ...
  const handleComplete = () => {
    setIsCompleted(true);
    setCourseSuccess(
      "Congratulations! You've completed the GitHub Mastery course!",
    );
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center space-x-4 text-gray-600">
              <div className="flex items-center space-x-1">
                ...
                <span>(2,031 reviews)</span>
              </div>
              <span>•</span>
              <span>7 weeks • Intermediate Level</span>
              <span>•</span>
              <span>by Joshua Kroose</span>
            </div>
          </div>
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-black rounded-xl overflow-hidden shadow-2xl mb-6">
                <div className="relative">
                  <iframe
                    ...
                    src={iframeSrc}
                    title="GitHub Mastery Course Video"
              ...
              <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Master Git and GitHub with our comprehensive course. Learn
                  version control, collaborative workflows, branching
                  strategies, and advanced Git techniques. Perfect for
                  developers who want to improve their collaboration and code
                  management skills. Build real projects using professional Git
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-gray-500">2,031 reviews</span>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-medium">193 Comments</span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      <textarea
                        ...
                        className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        rows="3"
                      />
                      <button
                        onClick={handleAddComment}
                        className="mt-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 cursor-pointer rounded-lg font-medium transition-colors"
                      >
                        Post Comment
                      </button>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        This course is essential for anyone wanting to work in a
                        professional development environment. Git workflows are
                        explained perfectly!
                      </p>
                  ...
                  <div className="flex space-x-3">
                    <div className="w-8 h-8 bg-cyan-500 rounded-full flex items-center justify-center">
                      <span className="text-white text-sm font-medium">LP</span>
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center space-x-2 mb-1">
                        <span className="font-medium text-gray-900">
                      ...
                      <p className="text-gray-700">
                        I finally understand merge conflicts and rebasing! The
                        step-by-step explanations are incredibly helpful.
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                          <ThumbsUp className="w-4 h-4" />
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700">
                        Best Git tutorial I've found. The practical projects
                        really solidify your understanding. Worth every minute!
                      </p>
                      <div className="flex items-center space-x-2 mt-2">
                        <button className="flex items-center space-x-1 text-gray-500 hover:text-blue-600">
                          <ThumbsUp className="w-4 h-4" />
